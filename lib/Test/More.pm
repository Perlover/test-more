...
sub ok ($;$) {
    my( $test, $name ) = @_;
    Test::Builder::logging("p_10");
    my $tb = Test::More->builder;
    Test::Builder::logging("p_11, ($test, $name) ref = " . ref($tb) . ", " . $tb . ", " . \&Test::Builder::ok);

    my $tmp;
    eval {     Test::Builder::logging("p_11_a"); $tmp = Test::Builder::ok( $tb, $test, $name ) };
    Test::Builder::logging("p_12_a error: " . $@) if $@;
    Test::Builder::logging("p_12 - " . $tmp);
    $tmp;
}
